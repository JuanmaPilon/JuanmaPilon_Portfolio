...
const  Cards = (props: Project) => {
    return (
        <div className="card bg-gradient-to-br bg-red-900 to-blue-900 rounded-xl shadow-md p-8 flex flex-col items-center text-center hover:scale-115 hover:shadow-lg trasition-transform duration-300 ease-in-out border-black/60 border-2 ">
