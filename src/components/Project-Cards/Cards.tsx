...
const  Cards = (props: Project) => {
    return (
        <div className="card bg-white rounded-xl shadow-md p-4 flex flex-col items-center text-center hover:scale-105 hover:shadow-lg trasition-transform duration-300 ease-in-out">
